...
- `pnpm dev`: Run local SvelteKit dev server.
- `pnpm storybook`: Run Storybook on port 6006.
- `pnpm build`: Package the library (includes CSS build).
...
- Components: PascalCase filenames (`Button.svelte`), stories `Button.stories.svelte`.
