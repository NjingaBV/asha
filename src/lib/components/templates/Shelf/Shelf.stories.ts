				...
				cards: [
					{
						...
						buttonLink:
							'https://www.youtube.com/watch?v=UnJ05tL_MNM',
		...
		slices: [
			{
				name: 'hero',
				title:
					"Des accessoires chics et malins pour avoir de l'allure.",
				overview:
					"Et si être élégante au quotidien n'était qu'une affaire de secondes?",
				imgSrc: {
					desktop:
			...
			},
			{
				...
				features: [
					...
					},
					{
						...
						description:
							'Courtier en assurances nouvelle génération.',
						details: {
							cover: {
